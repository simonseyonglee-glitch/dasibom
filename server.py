...
SEED_COMPANIES = [
    {"name":"현우 에듀","biz":"123-45-67890","industry":"교육","size":"small",
     ...
     "desc":"방과후 영어 교육 전문 기관, 전국 84개 학교 파트너십 보유"},
    {"name":"그린리프","biz":"234-56-78901","industry":"친환경","size":"medium",
     ...
     "desc":"친환경 라이프스타일 브랜드, 시간선택제 도입 5년차"},
    ...
    {"name":"맘스데이케어","biz":"456-78-90123","industry":"돌봄","size":"small",
     ...
     "desc":"가정 방문 아이돌봄 서비스, 베테랑 보육교사 우대"},
    {"name":"화이트박스","biz":"567-89-01234","industry":"IT","size":"small",
     "sido":"경기","sigungu":"성남시","logo":"화","wcert":"approved","wcert_score":4.2,
     "female":0.55,"mgr":0.42,"flex":0.85,
     "desc":"SaaS 데이터 솔루션, 하이브리드 근무"},
    {"name":"사람과미디어","biz":"678-90-12345","industry":"미디어","size":"medium",
     "sido":"서울","sigungu":"종로구","logo":"사","wcert":"approved","wcert_score":4.3,
     "female":0.67,"mgr":0.41,"flex":0.72,
     "desc":"여성 라이프 매거진 운영, 콘텐츠 제작 전문"},
    {"name":"테크우먼랩","biz":"890-12-34567","industry":"IT","size":"startup",
     "sido":"서울","sigungu":"강남구","logo":"테","wcert":"approved","wcert_score":4.9,
     "female":0.88,"mgr":0.71,"flex":0.95,
     "desc":"여성 개발자 100% 스타트업, 풀 원격근무"},
    {"name":"한빛헬스케어","biz":"901-23-45678","industry":"의료","size":"medium",
     "sido":"서울","sigungu":"송파구","logo":"한","wcert":"approved","wcert_score":4.4,
     "female":0.78,"mgr":0.48,"flex":0.62,
     "desc":"방문 간호 서비스, 시니어 간호사 우대"},
    {"name":"코지하우스","biz":"012-34-56789","industry":"부동산","size":"small",
     "sido":"경기","sigungu":"수원시","logo":"코","wcert":"under_review","wcert_score":3.9,
     "female":0.62,"mgr":0.30,"flex":0.55,
     "desc":"중년 여성 주거 컨설팅 전문 부동산"},
    {"name":"플로라마켓","biz":"111-22-33344","industry":"커머스","size":"medium",
     "sido":"인천","sigungu":"연수구","logo":"플","wcert":"approved","wcert_score":4.0,
     "female":0.65,"mgr":0.38,"flex":0.70,
     "desc":"꽃·식물 온라인 마켓, CS·MD 시간선택제 운영"},
    {"name":"바른회계법인","biz":"222-33-44455","industry":"전문서비스","size":"medium",
     "sido":"서울","sigungu":"여의도","logo":"바","wcert":"approved","wcert_score":4.5,
     "female":0.71,"mgr":0.52,"flex":0.80,
     "desc":"여성 회계사·세무사 다수 재직, 유연근무 정착"},
    {"name":"스피드코퍼","biz":"333-44-55566","industry":"무역","size":"large",
     "sido":"서울","sigungu":"중구","logo":"스","wcert":"rejected","wcert_score":2.8,
     "female":0.32,"mgr":0.12,"flex":0.25,
     "desc":"무역 상사 (인증 반려 사례)"},
]
...
SEED_JOBS = [
    ...
    {"co":"현우 에듀","title":"초등 방과후 영어 강사 (오전반)","cat":2,
     "desc":"방과후 초등 대상 영어 수업 (1~3학년). 학교 일정에 맞춘 오전 근무. 교재·교안 모두 제공.",
    ...
    {"co":"현우 에듀","title":"초등 방과후 영어 강사 (오후반)","cat":2,
     "desc":"방과후 초등 대상 영어 수업 (4~6학년). 오후 1시~5시 근무.",
     "qual":"영어 의사소통 가능자. 학원 강의 경험자 우대.",
     "wtypes":["part_time","flex"],"wmin":16,"wmax":20,
     "salary_type":"hourly","smin":28000,"smax":35000,
     "sido":"서울","sigungu":"서초구","remote":False,"gap":True,"senior":False,"noexp":True},
    {"co":"맘스데이케어","title":"아이돌봄 코디네이터 (사무+현장)","cat":2,
     "desc":"방문 돌봄 매칭 및 사후관리. 사무 70% + 현장 방문 30%.",
    ...
    {"co":"맘스데이케어","title":"방문 아이돌보미 (자녀 학교시간 근무)","cat":2,
     "desc":"오전 9시~오후 2시, 자녀 등하교 시간에 맞춘 방문 돌봄.",
     "qual":"보육교사 자격증 또는 유사 경험. 친절·성실 우선.",
     "wtypes":["part_time"],"wmin":20,"wmax":25,
     "salary_type":"hourly","smin":15000,"smax":18000,
     "sido":"서울","sigungu":"성동구","remote":False,"gap":True,"senior":True,"noexp":True},
    {"co":"한빛헬스케어","title":"방문 간호사 (시니어 케어)","cat":7,
     "desc":"어르신 가정 방문 간호. 주 3~4일 근무, 본인 일정 조율 가능.",
     "qual":"간호사 면허 보유 (RN). 5년 이상 경력 우대.",
     "wtypes":["part_time","flex"],"wmin":24,"wmax":32,
     "salary_type":"monthly","smin":3200000,"smax":3800000,
     "sido":"서울","sigungu":"송파구","remote":False,"gap":True,"senior":True,"noexp":False},
    ...
    {"co":"그린리프","title":"고객지원(CS) 매니저 (재택 가능)","cat":1,
     "desc":"이메일/채팅 기반 고객 응대. 주 3일 재택 + 주 2일 출근.",
     "qual":"한글 타이핑 빠르신 분. CS 경력 우대 (무경력도 OK).",
     "wtypes":["hybrid","flex"],"wmin":30,"wmax":35,
     "salary_type":"monthly","smin":2300000,"smax":2700000,
     "sido":"경기","sigungu":"분당구","remote":False,"gap":True,"senior":False,"noexp":True},
    {"co":"바른회계법인","title":"세무 보조 (경력단절 환영)","cat":1,
     "desc":"세무 신고 자료 정리 및 회계 보조. 시즌제 운영.",
     "qual":"회계·세무 관련 경력 1년 이상. 단절 기간 5년 이내 환영.",
     "wtypes":["part_time","flex"],"wmin":25,"wmax":30,
     "salary_type":"monthly","smin":2500000,"smax":3000000,
     "sido":"서울","sigungu":"여의도","remote":False,"gap":True,"senior":False,"noexp":False},
    {"co":"플로라마켓","title":"MD 어시스턴트 (단축근무)","cat":1,
     "desc":"상품 등록·재고 관리·납품처 커뮤니케이션. 10:00~16:00.",
     "qual":"꼼꼼하고 책임감 있는 분. MD/유통 경험 우대.",
     "wtypes":["part_time","flex"],"wmin":24,"wmax":30,
     "salary_type":"monthly","smin":2100000,"smax":2500000,
     "sido":"인천","sigungu":"연수구","remote":False,"gap":True,"senior":False,"noexp":True},
    {"co":"코지하우스","title":"부동산 행정 사무원","cat":1,
     "desc":"계약서 작성·고객 응대·매물 관리. 사무직 복귀 추천.",
     "qual":"엑셀·한글 가능. 부동산 경력 무관.",
     "wtypes":["part_time"],"wmin":25,"wmax":30,
     "salary_type":"monthly","smin":2000000,"smax":2400000,
     "sido":"경기","sigungu":"수원시","remote":False,"gap":True,"senior":True,"noexp":True},
    ...
    {"co":"노을디자인","title":"SNS 운영 매니저 (인스타그램)","cat":3,
     "desc":"인스타그램·블로그 콘텐츠 기획 및 운영.",
     "qual":"SNS 운영 경험 또는 본인 계정 팔로워 1천+ 우대.",
     "wtypes":["remote","part_time"],"wmin":20,"wmax":25,
     "salary_type":"monthly","smin":2200000,"smax":2700000,
     "sido":None,"sigungu":None,"remote":True,"gap":True,"senior":False,"noexp":True},
    {"co":"화이트박스","title":"데이터 입력/검수 매니저 (재택+사무)","cat":3,
     "desc":"고객 데이터 입력·정합성 검수. 주 3일 재택, 주 2일 판교 출근.",
     "qual":"엑셀 중급 이상. 꼼꼼함 필수.",
     "wtypes":["hybrid","flex"],"wmin":30,"wmax":35,
     "salary_type":"monthly","smin":2500000,"smax":3000000,
     "sido":"경기","sigungu":"성남시","remote":False,"gap":True,"senior":False,"noexp":True},
    {"co":"테크우먼랩","title":"QA 테스터 (모바일 앱)","cat":3,
     "desc":"앱 테스트 시나리오 작성 및 실행. 풀 원격.",
     "qual":"스마트폰 다양한 앱 사용 경험. 꼼꼼함이 가장 중요.",
     "wtypes":["remote","flex"],"wmin":25,"wmax":30,
     "salary_type":"monthly","smin":2800000,"smax":3400000,
     "sido":None,"sigungu":None,"remote":True,"gap":True,"senior":False,"noexp":True},
    {"co":"테크우먼랩","title":"기술 문서 작성자 (Technical Writer)","cat":3,
     "desc":"개발자 문서·사용자 가이드 작성. 100% 원격.",
     "qual":"글쓰기 자신 있는 분. IT 기본 용어 이해.",
     "wtypes":["remote","flex"],"wmin":25,"wmax":35,
     "salary_type":"monthly","smin":3500000,"smax":4500000,
     "sido":None,"sigungu":None,"remote":True,"gap":True,"senior":True,"noexp":False},
    {"co":"사람과미디어","title":"SNS 콘텐츠 운영 (시간선택제)","cat":3,
     "desc":"여성 라이프스타일 매거진 SNS 운영.",
     "qual":"무경력 OK. 교육 제공.",
     "wtypes":["part_time","hybrid"],"wmin":20,"wmax":25,
     "salary_type":"hourly","smin":18000,"smax":22000,
     "sido":"서울","sigungu":"종로구","remote":False,"gap":True,"senior":False,"noexp":True},

    # === 미디어/콘텐츠 ===
    {"co":"사람과미디어","title":"매거진 피처 작가 (프리랜서)","cat":3,
     "desc":"월 2~4회 인터뷰 기사 작성. 작성 건당 30만원.",
     "qual":"인터뷰 기사 작성 경험. 포트폴리오 필수.",
     "wtypes":["remote","flex"],"wmin":10,"wmax":20,
     "salary_type":"monthly","smin":1200000,"smax":2400000,
     "sido":None,"sigungu":None,"remote":True,"gap":True,"senior":True,"noexp":False},
    {"co":"노을디자인","title":"브랜드 카피라이터 (시니어)","cat":6,
     "desc":"브랜드 슬로건·캠페인 카피 작성. 풀 원격.",
     "qual":"카피라이팅 경력 5년+. 50대도 환영.",
     "wtypes":["remote","flex"],"wmin":25,"wmax":35,
     "salary_type":"monthly","smin":3500000,"smax":4500000,
     "sido":None,"sigungu":None,"remote":True,"gap":True,"senior":True,"noexp":False},

    # === 서비스 ===
    {"co":"플로라마켓","title":"플라워숍 매니저 (오프라인 매장)","cat":4,
     "desc":"매장 운영, 고객 응대, 꽃 관리.",
     "qual":"꽃을 사랑하는 분. 플라워 자격증 우대.",
     "wtypes":["part_time","flex"],"wmin":25,"wmax":30,
     "salary_type":"monthly","smin":2200000,"smax":2700000,
     "sido":"인천","sigungu":"연수구","remote":False,"gap":True,"senior":False,"noexp":True},
    {"co":"플로라마켓","title":"고객상담사 (콜센터, 단축근무)","cat":4,
     "desc":"전화·카톡 응대. 10~15시 단축근무 가능.",
     "qual":"친절한 응대 가능자. 콜센터 경력 우대.",
     "wtypes":["part_time","flex"],"wmin":20,"wmax":25,
     "salary_type":"hourly","smin":14000,"smax":17000,
     "sido":"인천","sigungu":"연수구","remote":False,"gap":True,"senior":True,"noexp":True},

    # === 전문직 ===
    {"co":"바른회계법인","title":"세무사 (경력자, 시간선택제)","cat":5,
     "desc":"개인 사업자 세무 자문. 주 3~4일 근무 가능.",
     "qual":"세무사 자격증 보유. 경력 3년+ 우대.",
     "wtypes":["part_time","flex"],"wmin":24,"wmax":32,
     "salary_type":"monthly","smin":4500000,"smax":6500000,
     "sido":"서울","sigungu":"여의도","remote":False,"gap":True,"senior":True,"noexp":False},
    {"co":"한빛헬스케어","title":"보건의료 정보관리사 (재택 가능)","cat":5,
     "desc":"의료기록 분류·코딩 업무.",
     "qual":"보건의료정보관리사 자격증. 재택 70%.",
     "wtypes":["remote","hybrid"],"wmin":30,"wmax":40,
     "salary_type":"monthly","smin":3000000,"smax":3500000,
     "sido":"서울","sigungu":"송파구","remote":True,"gap":True,"senior":True,"noexp":False},

    # === 추가 사무 ===
    {"co":"화이트박스","title":"HR 어시스턴트 (사무직 복귀형)","cat":1,
     "desc":"채용 지원, 직원 데이터 관리.",
     "qual":"HR 또는 사무 경력 3년+. 복귀자 환영.",
     "wtypes":["hybrid","flex"],"wmin":30,"wmax":35,
     "salary_type":"monthly","smin":2800000,"smax":3500000,
     "sido":"경기","sigungu":"성남시","remote":False,"gap":True,"senior":False,"noexp":False},

    # === 시니어 우대 콘텐츠 ===
    {"co":"테크우먼랩","title":"커뮤니티 매니저 (50+ 우대)","cat":3,
     "desc":"중년 여성 커뮤니티 운영 및 이벤트 기획.",
     "qual":"커뮤니티 운영 경험 또는 본인이 활발한 커뮤니티 멤버.",
     "wtypes":["remote","part_time"],"wmin":20,"wmax":25,
     "salary_type":"monthly","smin":2500000,"smax":3000000,
     "sido":None,"sigungu":None,"remote":True,"gap":True,"senior":True,"noexp":True},
]
